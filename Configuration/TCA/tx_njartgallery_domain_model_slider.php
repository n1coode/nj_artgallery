...
return [
	...
	'columns' => [
		...
		'sheets' => [
			'exclude' => 0,
			'label' => $nj_ext_lang_file.'label.domain.'.$nj_domain.'.sheets',
			'config' => [
				'type' => 'inline',
				'foreign_table' => $nj_extkey.'_domain_model_slidersheet',
	...
	'types' => [
        '0' => ['showitem' => 'hidden,sys_language_uid;;1,title,sheets']
    ],
    'palettes' => [
