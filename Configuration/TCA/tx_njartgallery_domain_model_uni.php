...
return [
	...
	'columns' => [
		...
		'name_short' => [
            'exclude' => 0,
            'label'   => $nj_ext_lang_file.'label.general.nameShort',
            'config'  => [
                'type' => 'input',
                'size' => 25,
                'eval' => 'trim,required',
		...
		'city' => [
            'exclude' => 0,
            'label'   => $nj_ext_lang_file.'label.domain.'.$nj_domain.'.city',
            'config'  => [
                'type' => 'input',
                'size' => 25,
                'eval' => 'trim',
	...
	'types' => [
        '0' => ['showitem' => 'hidden,sys_language_uid;;1,name,name_short,website']
    ],
    'palettes' => [
